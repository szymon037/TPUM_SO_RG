...
namespace Model.Repository
{
    public class Database
    {
        ...
        public Database()
        {
            ...
            Users.Add(new User { ID = Guid.NewGuid().ToString(), Name = "User1", Address = "User1Address" });
            Users.Add(new User { ID = Guid.NewGuid().ToString(), Name = "User2", Address = "User2Address" });
